    ...
    <div className="bg-[#120620] border-2 border-cyan-400 p-6 relative overflow-hidden shadow-[0_0_20px_rgba(34,211,238,0.15)]">
      ...
      <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <h2 className="text-xl md:text-2xl font-black italic tracking-tighter text-cyan-300 uppercase drop-shadow-[0_2px_4px_rgba(6,182,212,0.3)]">
          📊 OPPORTUNITY TELEMETRY RADAR
        </h2>
        <span className="text-[10px] font-mono text-pink-500 font-bold tracking-widest border border-pink-500/30 px-2 py-0.5 bg-pink-950/20 self-start sm:self-auto">
          GRID_MODE // ACTIVE
        </span>
      </div>
      ...
      <div className="h-[400px] w-full font-mono text-xs">
        <ResponsiveContainer width="100%" height="100%">
          <RadarChart cx="50%" cy="50%" outerRadius="80%" data={data}>
            ...
            <PolarAngleAxis
              dataKey="metric"
              tick={{ fill: '#22d3ee', fontWeight: 'bold', fontSize: 11, letterSpacing: '0.05em' }}
            />
      ...
      <div className="mt-4 pt-4 border-t border-pink-950/60 flex justify-between items-center text-[10px] font-mono text-pink-400/60">
