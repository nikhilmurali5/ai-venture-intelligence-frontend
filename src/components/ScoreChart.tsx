...
function ScoreChart({ data }: Props) {
  return (
    <div className="bg-[#120620] border-2 border-fuchsia-500 p-6 relative overflow-hidden shadow-[0_0_20px_rgba(240,46,170,0.15)] mt-8">
      ...
      <div className="mb-6 flex justify-between items-center">
        <h2 className="text-xl md:text-2xl font-black italic tracking-tighter text-fuchsia-400 uppercase drop-shadow-[0_2px_4px_rgba(240,46,170,0.3)]">
          📈 PERFORMANCE METRIC TRAJECTORY
        </h2>
        <span className="text-[10px] font-mono text-cyan-400 font-bold border border-cyan-500/30 px-2 py-0.5 bg-cyan-950/20">
          LIVE_FEED
        </span>
      </div>

      <div className="w-full font-mono text-[10px] text-pink-400/80">
        <ResponsiveContainer width="100%" height={300}>
          <LineChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
            ...
            <XAxis
              dataKey="id"
              tick={{ fill: '#22d3ee', fontWeight: 'bold' }}
              stroke="#2a1147"
            />
            <YAxis
              tick={{ fill: '#ec4899' }}
            ...
            <Line
              ...
              strokeWidth={4}
              dot={{ fill: '#22d3ee', stroke: '#ec4899', strokeWidth: 2, r: 4 }}
              activeDot={{ r: 7, fill: '#fff', stroke: '#22d3ee', strokeWidth: 2 }}
              style={{
